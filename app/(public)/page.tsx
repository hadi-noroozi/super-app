  ...
  return (
    <div className="w-full">
      ...
      <div className="grid gap-3">
        ...
        <div className="flex flex-column menu sm:max-w-[500px] mx-auto w-full">
          <div className="w-full grid grid-cols-4 gap-2 items-center justify-center  text-gray-500 cursor-pointer">
            <Link href=""
              className="flex flex-col items-center justify-center mx-auto w-18 h-18 rounded-xl text-[#CEA958] cursor-pointer p-2 hover:text-gray-400 hover:bg-[#181a1c] transition ease-in duration-300">
            ...
            <Link href=""
              className="flex flex-col items-center justify-center mx-auto w-18 h-18 rounded-lg text-[#CEA958]  hover:text-gray-400 hover:bg-[#181a1c] cursor-pointer  p-2 transition ease-in duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 48 48"
                    stroke="currentColor">
            ...
            <Link href=""
              className="flex flex-col items-center justify-center mx-auto w-18 h-18 rounded-lg hover:text-gray-400 hover:bg-[#181a1c] text-[#CEA958]  cursor-pointer  p-2  transition ease-in duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 48 48"
                    stroke="currentColor">
            ...
            <Link href="/tours"
              ...
              <p className="text-sm mt-1 yekanbakh">Tours</p>
            </Link>
            <Link href=""
              className="flex flex-col items-center justify-center mx-auto w-18 h-18 rounded-lg text-[#CEA958]  hover:text-gray-400 hover:bg-[#181a1c] cursor-pointer  p-2 transition ease-in duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 48 48"
        ...
        <div className="flex flex-col md:flex-row xl:flex-col gap-2 banner">
          <Image
            width={400}
            height={400}
            alt="test"
            src={"/images/banner/01.jpg"}
            className="h-[80px] w-full md:w-1/2 xl:w-full object-cover rounded-lg"
          />  
          <Image
            width={400}
            height={400}
        ...
        <div className="main flex flex-col overflow-hidden">
          <div className="destinations overflow-hidden mt-6">
            ...
            <div className="sm:w-full flex overflow-x-auto no-scrollbar gap-x-2 pb-1">
          ...
          <div className="Residences overflow-hidden mt-6">
            ...
            <div className="sm:w-full flex overflow-x-auto no-scrollbar gap-x-2 pb-1">
              <Link href="" className="relative max-w-[300px] h-[290px] rounded-lg border-1 border-gray-500">
                <Image
                  width={400}
                  height={400}
                  alt="test"
                ...
                <span className="absolute top-0 left-0 px-2 pt-1 rounded-tl-md rounded-br-md text-sm yekanbakh bg-gray-500 text-white">
                  10%
                </span>
              </Link>
          ...
          <div className="Residences overflow-hidden mt-6">
            <div className="flex flex-row justify-between items-center mb-2">
              <h2 className="yekanbakh text-lg text-[#CEA958]">Rasht Best Residence</h2>
              <Link href="" className="text-white flex items-center text-sm">
              See All
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="ml-1 w-3 h-3">
                <path d="M18.484375 2.984375 A 1.50015 1.50015 0 0 0 17.439453 5.5605469L35.878906 24L17.439453 42.439453 A 1.50015 1.50015 0 1 0 19.560547 44.560547L39.060547 25.060547 A 1.50015 1.50015 0 0 0 39.060547 22.939453L19.560547 3.4394531 A 1.50015 1.50015 0 0 0 18.484375 2.984375 z" fill="currentColor"/>
          ...
          <div className="Hotels overflow-hidden mt-6">
            <div className="flex flex-row justify-between items-center mb-2">
              <h2 className="yekanbakh text-lg text-[#CEA958]">Rasht Best Hotel</h2>
              <Link href="" className="text-white flex items-center text-sm">
              See All
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="ml-1 w-3 h-3">
                <path d="M18.484375 2.984375 A 1.50015 1.50015 0 0 0 17.439453 5.5605469L35.878906 24L17.439453 42.439453 A 1.50015 1.50015 0 1 0 19.560547 44.560547L39.060547 25.060547 A 1.50015 1.50015 0 0 0 39.060547 22.939453L19.560547 3.4394531 A 1.50015 1.50015 0 0 0 18.484375 2.984375 z" fill="currentColor"/>
            ...
            <div className="sm:w-full flex overflow-x-auto no-scrollbar gap-x-2 pb-1">
              <Link href="" className="relative min-w-[300px] h-[290px] rounded-lg border-1 border-gray-500">
                <Image
                  width={400}
                  height={400}
                  alt="test"
                ...
                <div className="p-2 flex flex-col gap-y-2">
                  ...
                  <h3 className="yekanbakh font-light whitespace-nowrap overflow-hidden text-ellipsis">
                    Kadous Hotel Rasht
                  </h3>
                  <div className="flex flex row justify-between yekanbakh">
                    <div className="text-gray-400 text-sm">
          ...
          <div className="Tours overflow-hidden mt-6">
            <div className="flex flex-row justify-between items-center mb-2">
              <h2 className="yekanbakh text-lg text-[#CEA958]">Specially recommended tours</h2>
              <Link href="" className="text-white flex items-center text-sm">
              See All
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="ml-1 w-3 h-3">
                <path d="M18.484375 2.984375 A 1.50015 1.50015 0 0 0 17.439453 5.5605469L35.878906 24L17.439453 42.439453 A 1.50015 1.50015 0 1 0 19.560547 44.560547L39.060547 25.060547 A 1.50015 1.50015 0 0 0 39.060547 22.939453L19.560547 3.4394531 A 1.50015 1.50015 0 0 0 18.484375 2.984375 z" fill="currentColor"/>
            ...
            <div className="sm:w-full flex overflow-x-auto no-scrollbar gap-x-2 pb-1">
              <Link href="" className="relative min-w-[300px] h-[290px] rounded-lg border-1 border-gray-500">
                <Image
                  ...
                  height={400}
                  alt="test"
                  src={"/images/tours/rasht-vip.jpg"}
                  className="w-full h-[160px] object-cover rounded-t-lg"/>
                <div className="p-2 flex flex-col gap-y-2">
                  <div className="flex flex-row items-center justify-between">
                    <span className="flex yekanbakh text-sm gap-x-1 text-yellow-500">
                  ...
                  <h3 className="yekanbakh font-light whitespace-nowrap overflow-hidden text-ellipsis">
                    Gilan recreational-therapy VIP tour
                  </h3>
                  <div className="flex flex row justify-between yekanbakh">
              ...
              <Link href="" className="relative min-w-[300px] h-[290px] rounded-lg border-1 border-gray-500">
                <Image
                  ...
                  height={400}
                  alt="test"
                  src={"/images/tours/rasht-special.jpg"}
                  className="w-full h-[160px] object-cover rounded-t-lg"/>
                <div className="p-2 flex flex-col gap-y-2">
                  <div className="flex flex-row items-center justify-between">
                    <span className="flex yekanbakh text-sm gap-x-1 text-yellow-500">
                  ...
                  <h3 className="yekanbakh font-light whitespace-nowrap overflow-hidden text-ellipsis">
                  Special recreational tour of Gilan
                  </h3>
                  <div className="flex flex row justify-between yekanbakh">
                    <div className="text-gray-400 text-sm flex gap-x-1">
                      <span>April</span>
              ...
              <Link href="" className="relative min-w-[300px] h-[290px] rounded-lg border-1 border-gray-500">
                <Image
                  ...
                  height={400}
                  alt="test"
                  src={"/images/tours/rash-normal.webp"}
                  className="w-full h-[160px] object-cover rounded-t-lg"/>
                <div className="p-2 flex flex-col gap-y-2">
                  <div className="flex flex-row items-center justify-between">
                    <span className="flex yekanbakh text-sm gap-x-1 text-yellow-500">
